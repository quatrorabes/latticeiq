...
class SalesforceClient:
	...
	def get_contacts(self, soql: Optional[str] = None) -> List[Dict[str, Any]]:
		...
		query = soql or "SELECT Id, FirstName, LastName, Email, Phone, Company__c, Title FROM Contact LIMIT 10000"
