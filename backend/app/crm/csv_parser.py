...
class CSVContact(BaseModel):
    ...
    job_title: Optional[str] = None  # FIXED: was "title"
...
class CSVParser:
    ...
    OPTIONAL_COLUMNS = [
        ...
        'title', 'job_title', 'jobtitle',  # ADDED: more variations
    ...
    def parse(self, file_content: bytes) -> Tuple[List[CSVContact], List[str]]:
        ...
        for row_num, row in enumerate(reader, start=2):
            try:
                ...
                job_title = self._get_field(normalized_row, ['job_title', 'jobtitle', 'title'], None)  # FIXED
                linkedin_url = self._get_field(normalized_row, ['linkedin_url', 'linkedin_profile', 'linkedin'], None)
                ...
                contact = CSVContact(
                    ...
                    phone=phone,
                    company=company,
                    job_title=job_title,  # FIXED: was "title"
